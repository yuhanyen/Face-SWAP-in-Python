...
if __name__ == '__main__' :
    ...
    if len(sys.argv)==5:
        ...
        OutPutImgPATH=OutPutImgPATH+"OutPut_"+filename3
    else:
        OutPutImgPATH="OutPut_"+filename3
    ...
    points2 = getPoints(filename2)##readPoints(filename2 + '.txt')    
